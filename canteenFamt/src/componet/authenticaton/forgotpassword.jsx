    ...
    return (
            ...
            <div className="bg-[#0F6657] w-[23vw] pt-[2vw] pb-[1vw] rounded-[0.6vw]">
                ...
                <div className="bg-[#F8FAFC] rounded-[0.4vw] flex flex-col gap-4 p-[1.5vw] m-[1.3vw] pt-[2vw]">
                    <div>
                        <h2 className="text-[0.9vw] text-center mb-[0.6vw] font-[400] text-gray-500"><span className="text-[#FBA808] text-[1.5vw] font-700">Mail Address Here</span><br /> Enter the email address asssociated with your account</h2>
